...
namespace SerialTool
{
    public partial class SerialFrm : Form
    {
        ...
        private void btnOpenPort_Click(object sender, EventArgs e)
        {
            ...
            new Serial(cboPort.Text, cboBaudRate.Text, cboDataBits.Text, cboStopBits.Text, cboCheck.Text);
        ...
        private async void btnSend_Click(object sender, EventArgs e)
        {
            ...
            Serial.serialPort.DataReceived -= new SerialDataReceivedEventHandler(DataReceivedHandler);
            Serial.serialPort.DataReceived -= new SerialDataReceivedEventHandler(DataReceivedHandler);
            string rcv = await Serial.SendAndRcv(this.txtSend.Text);
        ...
        private void DataReceivedHandler(object sender, SerialDataReceivedEventArgs e)
        {
            ...
            this.Invoke(new Action(() =>
           {
               ...
               txtAccept.AppendText($"{TimeGetTool.TextTime()}[主动上报]--接收--> {Serial.OnlyRcv()}\r\n");
